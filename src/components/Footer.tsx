...
const Footer = () => {
  return (
    <footer className="bg-dark pt-5 pb-12 dark:bg-slate-800">
      <div className="container">
        <div className="w-full">
          <div className="max-w-xl mx-auto text-center mb-5">
            <div className="font-bold text-2xl text-white mb-2">
              <img src={logo} width="50" alt="elvxk" className="mx-auto"></img>
          ...
          <div className="w-full px-2">
            <div className="w-full pt-5 border-t border-slate-700">
              <div className="flex items-center justify-center mb-5">
                ...
                {/* <!-- YT --> */}
                <a
                  href="https://www.youtube.com/channel/UCSxx8kJXYJv89i-5kZ4QXog"
                  target="_blank"
                  className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border 
                        border-slate-300 hover:border-primary hover:bg-primary hover:text-white text-slate-300"
                >
